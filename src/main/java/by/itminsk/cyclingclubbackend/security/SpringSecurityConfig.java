...
public class SpringSecurityConfig {
    ...
    { http
		...
		.cors(cors -> cors.disable())
            ...
            .requestMatchers("/api/register", "/api/authenticate", "/hello", "api/signup", "api/restore-password", "api/signup-complete",  "api/verify", "api/get/**", "api/check-tel", "api/restore/restore-password").permitAll()
